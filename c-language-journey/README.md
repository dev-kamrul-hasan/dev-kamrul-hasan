...
* **Memory:** Used `int year = 2026;` to see how the RAM holds a value before printing it.
* **The Entry Point:** Everything starts in `int main()`—the mandatory starting point for the OS to read my logic.
